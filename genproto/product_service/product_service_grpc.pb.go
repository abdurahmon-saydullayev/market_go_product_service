...
type ProductServiceClient interface {
	...
	GetByID(ctx context.Context, in *ProductPK, opts ...grpc.CallOption) (*Product, error)
	...
	UpdatePatch(ctx context.Context, in *UpdatePatchProduct, opts ...grpc.CallOption) (*Product, error)
	Delete(ctx context.Context, in *ProductPK, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *productServiceClient) GetByID(ctx context.Context, in *ProductPK, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
...
func (c *productServiceClient) UpdatePatch(ctx context.Context, in *UpdatePatchProduct, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
	err := c.cc.Invoke(ctx, "/product_service.ProductService/UpdatePatch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) Delete(ctx context.Context, in *ProductPK, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ProductServiceServer interface {
	...
	GetByID(context.Context, *ProductPK) (*Product, error)
	...
	UpdatePatch(context.Context, *UpdatePatchProduct) (*Product, error)
	Delete(context.Context, *ProductPK) (*empty.Empty, error)
...
func (UnimplementedProductServiceServer) GetByID(context.Context, *ProductPK) (*Product, error) {
...
func (UnimplementedProductServiceServer) UpdatePatch(context.Context, *UpdatePatchProduct) (*Product, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdatePatch not implemented")
}
func (UnimplementedProductServiceServer) Delete(context.Context, *ProductPK) (*empty.Empty, error) {
...
func _ProductService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetByID(ctx, req.(*ProductPK))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductService_UpdatePatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdatePatchProduct)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).UpdatePatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product_service.ProductService/UpdatePatch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).UpdatePatch(ctx, req.(*UpdatePatchProduct))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).Delete(ctx, req.(*ProductPK))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_UpdatePatch_Handler,
		},
		{
			MethodName: "Delete",
