...
type CategoryServiceClient interface {
	...
	GetByID(ctx context.Context, in *CategoryPK, opts ...grpc.CallOption) (*Category, error)
	...
	UpdatePatch(ctx context.Context, in *UpdatePatchCategory, opts ...grpc.CallOption) (*Category, error)
	Delete(ctx context.Context, in *CategoryPK, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *categoryServiceClient) GetByID(ctx context.Context, in *CategoryPK, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
...
func (c *categoryServiceClient) UpdatePatch(ctx context.Context, in *UpdatePatchCategory, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
	err := c.cc.Invoke(ctx, "/product_service.CategoryService/UpdatePatch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) Delete(ctx context.Context, in *CategoryPK, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type CategoryServiceServer interface {
	...
	GetByID(context.Context, *CategoryPK) (*Category, error)
	...
	UpdatePatch(context.Context, *UpdatePatchCategory) (*Category, error)
	Delete(context.Context, *CategoryPK) (*empty.Empty, error)
...
func (UnimplementedCategoryServiceServer) GetByID(context.Context, *CategoryPK) (*Category, error) {
...
func (UnimplementedCategoryServiceServer) UpdatePatch(context.Context, *UpdatePatchCategory) (*Category, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdatePatch not implemented")
}
func (UnimplementedCategoryServiceServer) Delete(context.Context, *CategoryPK) (*empty.Empty, error) {
...
func _CategoryService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetByID(ctx, req.(*CategoryPK))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CategoryService_UpdatePatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdatePatchCategory)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).UpdatePatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product_service.CategoryService/UpdatePatch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).UpdatePatch(ctx, req.(*UpdatePatchCategory))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CategoryService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).Delete(ctx, req.(*CategoryPK))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CategoryService_UpdatePatch_Handler,
		},
		{
			MethodName: "Delete",
